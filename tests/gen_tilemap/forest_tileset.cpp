...
const std::array<Color, 53> raw_forest_palette = {
    Color
    { 0,  0,  0}, {31, 31, 18},
    {28, 28, 12}, {19, 26,  7},
    {25, 23, 24}, {22, 23, 14},
...
const std::array<Tile, 256> forest_tiles = {
    Tile
    {{
        0x0, 0x0,
        0x0, 0x0,
...
const Palette test::maps::forest_palette{raw_forest_palette};

const Tileset test::maps::forest_tileset{
    forest_palette,
    forest_tiles
};
